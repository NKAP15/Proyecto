...
router.get("/branches/new", isAuthenticated,isAdmin,renderBranchForm);  // Formulario para crear una sucursal
router.post("/branches",isAuthenticated, isAdmin,createBranch);  // Crear una nueva sucursal
